...
class Employee:
    ...
    @property
    def email(self):
        return "{}.{}@silverado.com".format(self.first, self.last)
...
emp_2 = Employee("Devon", "O'connor", 40000)
...
emp_2.first = 'Devon'
emp_2.last = 'O\'Connor'
emp_2.email = 'o_devon@yahoo.com'''

#Creats a instance variable for emp_1
...
man_1 = Manager('Lauren', 'Glush', 100000, ['Aaron', 'Delany'])    
